...
import { showReviewTotal, populateUser, showDetails, addReviews  } from "./functions.js"
import { Permissions, LoyaltyUser } from "./enums.js";
import { Property, Review, You } from "./interfaces.js";
...
let currentLocation : [string, string, number] = ['Prague', '08:00', 18]
footer.innerHTML = currentLocation[0] + ' ' + currentLocation[1] + ' ' + currentLocation[2] + '&#8451';


//Add main property

let myMainProperty = new MainProperty(
